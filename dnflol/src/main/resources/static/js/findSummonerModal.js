		...
		$.ajax({
			...
			success : function(summoner) {
				if (summoner) {
					...
					input = "<div class=\"d-flex flex-column\"><div class=\"d-flex justify-content-center\"><img src=\"/lol/img/profileicon/" + profileIconId +".png\" width=\"140px\"></div><br/><div class=\"d-flex flex-row\"><div class=\"d-flex flex-column\"><div class=\"d-flex flex-column\">" + "아이디 : " + name + ", 레벨 : " + summonerLevel + "</div><div class=\"d-flex flex-column\" id=\"tierInfo\"></div></div><div class=\"d-flex flex-row\"><form action=\"/lol/addSummoner\" method=\"post\"><input type=\"hidden\" name=\"summonerName\" value=\"" + name + "\"/><input name=\"" + csrf_parameterName + "\" type=\"hidden\" value=\"" + csrf_token + "\" /><button type=\"submit\" class=\"btn btn-success\" style=\"float:right; margin-top:7px; margin-left:10px\">계정과 연동하기</button></form></div></div></div>";
