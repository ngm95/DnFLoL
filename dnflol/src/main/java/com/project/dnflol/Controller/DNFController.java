...
//	}
	 ...
	 */
	@RequestMapping("/charDetail/{dcharName}")
	public ModelAndView dnfCharDetail(Model model, @PathVariable("dcharName") String dcharName) {
		objectMapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
		
		DCharDTO dcharDto = dcServ.readByName(dcharName);
